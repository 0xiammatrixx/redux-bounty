...
const Home = () => {
  ...
  <h1 className="text-4xl font-bold text-dark-color mb-6">
    Welcome {currentUser ? 'to our site, Customer' : 'Guest User'}!
  </h1>
  <p className="text-lg text-dark-color mb-10 max-w-2xl text-center">
    Discover products with a visual twist.
  </p>

  <h2 className="text-2xl font-semibold mb-4 text-dark-color">Latest Items On Sale</h2>
